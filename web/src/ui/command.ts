...
const SLASH_COMMANDS: CmdEntry[] = [
  ...
  { name: '/agent ', desc: '子Agent(planner/coder/reviewer/coordinator)' },
  { name: '/goal ', desc: 'Outer Loop 目标执行' },
  { name: '/skill create ', desc: '创建新技能 SKILL.md' },
  { name: '/mcp add ', desc: '手动添加 MCP 服务器' },
  { name: '/mcp list', desc: '列出 MCP 服务器' },
